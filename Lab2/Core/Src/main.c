...
void display7SEG(int num) {
	...
	if(num == 2){
		...
		HAL_GPIO_WritePin(GPIOB, B_Pin, GPIO_PIN_RESET); // Segment B
		HAL_GPIO_WritePin(GPIOB, C_Pin, GPIO_PIN_SET); // Segment C
